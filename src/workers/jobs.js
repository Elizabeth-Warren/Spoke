...
// NOTE: currently not supported. In oder to support this, it should
// be enough to figure out the messaging_service_sid for each message
// part. The easiest way to do that is probably by adding messaging_service_sid
// to PendingMessagePart
